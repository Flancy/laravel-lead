...
var vm = new _vue2.default({
  ...
  methods: {
    ...
    filterLeads: function filterLeads(val) {
    ...
    getUserMoney: function getUserMoney() {
      ...
      this.$http.get('/debit/get-money').then(function (response) {
    ...
    addMoney: function addMoney() {
      ...
      this.$http.patch('/debit/add-money', { 'money': money }).then(function (response) {
